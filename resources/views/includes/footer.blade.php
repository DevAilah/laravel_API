    ...
    <div class="row">
        <div class="col-lg-3 col-md-6">
            <div class="footer-widget">
                ...
                <div class="contact-info">
                    <p><i class="fa fa-map-marker"></i>Oginga Odinga Street, Kisumu, Kenya</p>
                    <p><i class="fa fa-envelope"></i>www.cadache.co.ke</p>
                    <p><i class="fa fa-phone"></i>+2547-2095-7395</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="footer-widget">
                <h2>Our members</h2>
                <ul>
                    <li><a href="/members">Administrators</a></li>
